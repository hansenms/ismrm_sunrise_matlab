...
%function img = fbp_fan_flat(sino, G, window, varargin)
%
% FBP reconstruction of fan-beam tomography data collected with a flat detector.
...
arg_num = inline('str2num(arg_get(G.arg.args, arg))', 'G', 'arg');
arg_num_def = inline('str2num(arg_get(G.arg.args, arg, def))', 'G', 'arg', 'def');
