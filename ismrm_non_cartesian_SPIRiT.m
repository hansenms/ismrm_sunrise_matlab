...
%
%   ismrm_non_cartesian_SPIRiT(inp,k,w,mat_size,cal,csm,replicas)
%
...
%     - csm         [x,k,coil]           : Optional coil sensitivity map (for coil combination)
...
kernel_mask(bitshift(kernel_size+1,-1) + 1,bitshift(kernel_size+1,-1)) = 0;
