...
if (strcmp(transpose_indicator,'transp')),
    ...
    inp1 = inp(1:ele);
    inp2 = inp((ele+1):end);
    outp1 = ismrm_sampling_cartesian_SPIRiT(inp1,sampling_mask,transpose_indicator)*scale;
    outp2 = ismrm_image_kernel_SPIRiT(inp2,im_kernel,transpose_indicator);
    outp = outp1(:) + outp2(:);
elseif (strcmp(transpose_indicator, 'notransp')),
    outp1 = ismrm_sampling_cartesian_SPIRiT(inp,sampling_mask,transpose_indicator)*scale;
